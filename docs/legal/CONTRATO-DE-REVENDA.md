# CONTRATO DE LICENCIAMENTO DE USO DA PLATAFORMA E REVENDA DE CURSOS
...
d) Eventuais inscrições estaduais/municipais necessárias à emissão de notas fiscais.
...
a) **Multa moratória** de 2% (dois por cento) sobre o valor inadimplido;

b) **Juros de mora** de 1% (um por cento) ao mês, pro rata die;

c) **Correção monetária** pelo IPCA ou índice equivalente;
...
e) **Política de reembolso da Vitrine**, observado o mínimo legal previsto no CDC e nos Termos de Uso do Aluno;

f) **Atendimento ao Aluno** em primeira instância (suporte comercial, dúvidas sobre pedido, cupom, financeiro, política da Vitrine);

g) **Identidade visual da Vitrine** (logo, cores, banners, textos institucionais), desde que não viole direitos de terceiros ou estes Termos;

h) **Veiculação publicitária e marketing** dos Cursos da sua Vitrine;
...
b) A descrição fidedigna do conteúdo, carga horária e certificação esperada;

c) A política de reembolso aplicável;

d) Os canais de atendimento ao Aluno;
...
f) Realizar **engenharia reversa, descompilação, scraping massivo ou cópia** do código, design ou base de dados da Plataforma;
...
b) **Treinar** seus Consultores sobre estes Termos e sobre o uso adequado da Plataforma;

c) **Revogar imediatamente** o acesso de Consultores desligados;
...
f) Não exigir dos Alunos **mais dados do que estritamente necessários** à finalidade da Vitrine;
...
**14.3. Alteração de Plano.** A alteração de Planos comerciais (valor, escopo, limites) seguirá a regra da Cláusula 5.4.
...
b) Violação da Cláusula 6.3 (condutas vedadas);

c) Violação da Cláusula 11 (propriedade intelectual e não-concorrência);
...
**16.5. Efeitos da rescisão.** A partir da rescisão, **independente da modalidade**:

a) O acesso ao Painel será **revogado**;
...
(iii) Por correspondência postal com aviso de recebimento aos endereços indicados na Cláusula 20.

**18.4. Tolerância e Renúncia.** O não exercício, pelas Partes, de qualquer direito previsto neste Contrato, na primeira ocasião em que seria possível fazê-lo, **não significará renúncia** a tais direitos, nem sua preclusão.

**18.5. Independência das Disposições.** Se qualquer disposição deste Contrato for considerada inválida, inexequível ou sem efeito, as demais permanecerão em pleno vigor.

**18.6. Aceitação Integral.** Este Contrato, juntamente com a Política de Privacidade e o Plano contratado, constitui o **acordo integral** entre as Partes sobre o objeto, substituindo todos os entendimentos anteriores, escritos ou verbais.

**18.7. Caso Fortuito e Força Maior.** Nenhuma das Partes responderá por inadimplemento decorrente de caso fortuito ou força maior, devidamente comprovados, nos termos do art. 393 do Código Civil.

**18.8. Conformidade Anticorrupção.** As Partes obrigam-se a observar a **Lei nº 12.846/2013 (Lei Anticorrupção)** e demais normas aplicáveis, abstendo-se de oferecer, prometer ou conceder vantagem indevida a agente público em razão da execução deste Contrato.

**18.9. Linguagem.** Este Contrato é redigido em português brasileiro, idioma único de interpretação e foro.
...
**19.4. Foro de Eleição.** Não havendo composição amigável, fica eleito o **foro da Comarca de Contagem/MG**, com expressa renúncia a qualquer outro, por mais especial ou privilegiado que seja, para dirimir quaisquer controvérsias oriundas deste Contrato.
...
>
> 5. POSSUO CAPACIDADE TÉCNICA, FINANCEIRA, FISCAL E JURÍDICA PARA EXERCER A ATIVIDADE OBJETO DESTE CONTRATO;
>
> 6. RECONHEÇO QUE OS LIMITES DE RESPONSABILIDADE E DEMAIS CLÁUSULAS DESTE CONTRATO INTEGRAM O EQUILÍBRIO ECONÔMICO DO NEGÓCIO E FORAM EXPRESSAMENTE CONSIDERADOS NA DEFINIÇÃO DA MENSALIDADE.
>
> **ADERI AO PROFISSIONALIZA MAIS BRASIL POR CONCORDAR INTEGRAL E INCONDICIONALMENTE COM SUAS REGRAS E CONDIÇÕES, ESTANDO APTO E DISPOSTO A CUMPRI-LAS.**
