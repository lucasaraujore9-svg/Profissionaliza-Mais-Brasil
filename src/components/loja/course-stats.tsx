  ...
  return (
    <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
      {stats.map((stat) => (
        ...
        >
          <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--color-pmb-lime-50)] text-[var(--color-pmb-green)]">
            <stat.icon className="h-5 w-5" />
          </div>
          <div className="mt-3 font-mono text-xl font-bold text-[var(--color-pmb-green-900)]">
            {stat.value}
          </div>
