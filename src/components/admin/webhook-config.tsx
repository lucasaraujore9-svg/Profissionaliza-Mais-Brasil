  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <h3 className="text-sm font-semibold text-[var(--color-pmb-green-900)]">Webhook secrets</h3>
        ...
        <div className="mt-5 space-y-3">
          <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 p-4">
            <div>
              <p className="text-xs font-semibold text-[var(--color-pmb-green-900)]">Asaas Webhook Token</p>
          ...
          <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 p-4">
            <div>
              <p className="text-xs font-semibold text-[var(--color-pmb-green-900)]">Cron Secret</p>
              <p className="mt-0.5 text-[11px] text-gray-600">
