  ...
  return (
    ...
    >
      ...
      <div className="mt-6 space-y-4 max-w-md">
        <div>
          <Label htmlFor="admin-sec-atual">Senha atual</Label>
        ...
        <div>
          <Label htmlFor="admin-sec-nova">Nova senha</Label>
          <div className="relative mt-1.5">
            <Lock className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400" />
            <Input
              id="admin-sec-nova"
        ...
        <div>
          <Label htmlFor="admin-sec-confirm">Confirmar nova senha</Label>
          <div className="relative mt-1.5">
            <Lock className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400" />
            <Input
              id="admin-sec-confirm"
              type="password"
