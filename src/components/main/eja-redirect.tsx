...
/**
 * Tela de loading institucional do EJA — espelha a da Escola Técnica, mas com
 * copy adaptada para o "EJA Mais Brasil". Conta um tempo, mostra barra de
 * progresso e então redireciona para o destino externo (`url`).
 */
export function EjaRedirect({ url, delayMs = DEFAULT_DELAY_MS }: EjaRedirectProps) {
    ...
    <section className="flex min-h-[calc(100vh-180px)] items-center justify-center bg-[var(--color-pmb-mist)] px-4 py-12">
      <div className="w-full max-w-xl rounded-2xl border border-[rgba(2,89,24,0.1)] bg-white p-7 shadow-[0_18px_40px_-18px_rgba(2,89,24,0.25)] sm:p-10">
        ...
        <h1 className="mt-3 text-[22px] font-black leading-tight text-[var(--color-pmb-green)] sm:text-[26px]">
          Sua certificação começa agora.
        </h1>

        {/* Body — copy adaptada para EJA */}
        <div className="mt-3 space-y-2.5 text-[14.5px] leading-relaxed text-[rgba(2,89,24,0.78)]">
          <p>
            Parabéns pela sua escolha! Estamos conectando você ao{" "}
            <b>EJA Mais Brasil</b>, o programa de Educação de Jovens e Adultos
            para você retomar e concluir os estudos no seu ritmo.
          </p>
          <p>
            Conclua o <b>ensino fundamental ou médio</b> com certificado válido
            em todo o Brasil, estudando de onde estiver, com flexibilidade total
            e o apoio de quem entende de educação.
          </p>
          <p className="font-bold text-[var(--color-pmb-green)]">
            Mais perto do diploma. Mais perto das suas oportunidades. Mais perto
            dos seus objetivos.
          </p>
        </div>
        ...
        <div className="mt-6">
          <div className="flex items-center justify-between text-[12px] font-medium text-[rgba(2,89,24,0.55)]">
            ...
            <span>
              {cancelled ? "—" : remaining > 0 ? `${remaining}s` : "indo…"}
            </span>
          </div>
