  ...
  return (
    <AlertDialogPrimitive.Portal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        className={cn(
          "fixed left-1/2 top-1/2 z-50 grid w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl border border-zinc-200 bg-white p-6 shadow-2xl",
