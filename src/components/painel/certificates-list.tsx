...
import { Award, Download, Eye, FileText, Loader2, RefreshCw, X } from "lucide-react"
      ...
      <div className="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm">
        <table className="min-w-full divide-y divide-gray-200 text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            {loading ? (
              <tr>
                <td colSpan={showTenantColumn ? 8 : 7} className="p-0">
                  <TableRowsSkeleton rows={6} cols={showTenantColumn ? 8 : 7} />
                </td>
              </tr>
            ) : rows.length === 0 ? (
              <tr>
                <td colSpan={showTenantColumn ? 8 : 7} className="p-0">
                  <EmptyState
                    ...
                    description="Ajuste os filtros ou emita um novo certificado para vê-lo aqui."
                    className="border-0"
                  />
                </td>
              </tr>
              ...
              rows.map((row) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Td>
                      {revoked ? (
                        <StatusBadge tone="danger">Revogado</StatusBadge>
                      ) : (
                        <StatusBadge tone="success">Emitido</StatusBadge>
                      )}
                    </Td>
        ...
        <AlertDialogContent className="border-2 border-red-200">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {revoking ? (
                <>
                  O certificado{" "}
                  <span className="font-mono">{revoking.code}</span> de{" "}
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              ...
              disabled={revokeSubmitting || revokeReason.trim().length < 3}
