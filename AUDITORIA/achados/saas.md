...
- **Severidade:** P3
- **Status:** Aberto (achado NOVO — cobertura de rota antes ausente; rota existe desde 2fe5214, 2026-04-30)
...
- **Severidade:** P3
- **Status:** Aberto (re-confirmado 2026-07-03 — `src/proxy.ts:333-367`)
...
- **Severidade:** P3
- **Status:** Aberto (re-confirmado 2026-07-03 — `revendas/[id]/page.tsx:65-66,97-98`)
