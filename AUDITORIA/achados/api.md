...
- **Correção (2026-07-03):** API-009 (P2) **Corrigido** · API-004 (P3) **Corrigido** · API-005 (P3) **Corrigido** · API-008 (P3) **Corrigido** · API-010 (P3) **Corrigido** · API-007 (P3) **Corrigido** (junto com PERF-010, commit 3a02a48 — sync incremental do webhook de catálogo).
