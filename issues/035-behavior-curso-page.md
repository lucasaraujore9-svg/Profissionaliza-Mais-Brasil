...
Implementar página curso com dados reais: carregar curso DB + lições EA API, aplicar cupom desconto, calcular preço final, botão "Matricular-se" redireciona checkout.

## Componentes Envolvidos
- GET /api/loja/cursos/[slug] — carregar curso do tenant
- GET EA cursos/listar — listar lições/módulos
...
- `load-lessons-from-ea` — GET EA cursos/listar para idcurso
...
- [ ] GET EA cursos/listar usando lib/escola-avancada client
