# AGENTS.md — Profissionaliza Mais Brasil
...
### Como usar
Apos configurar o `.mcp.json` na raiz, reinicie o Codex. As ferramentas do Supabase ficarao disponiveis automaticamente para queries diretas no banco, gerenciamento de tabelas, RLS policies, etc.
